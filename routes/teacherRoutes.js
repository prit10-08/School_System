...
const { getStudents, getStudentById, createStudent, updateStudent, deleteStudent, getStudentMarks, addMark, updateMark, deleteMark, updateMyProfile, uploadStudentsCSV, getTeacherStats } = require("../controllers/teacherController");
